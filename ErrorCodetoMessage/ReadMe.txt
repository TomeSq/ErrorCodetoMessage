========================================================================
    コンソール アプリケーション: ErrorCodetoMessage プロジェクトの概要
========================================================================

この ErrorCodetoMessage アプリケーションは、AppWizard により作成されました。

このファイルには、ErrorCodetoMessage 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


ErrorCodetoMessage.vcxproj
...
ErrorCodetoMessage.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、ErrorCodetoMessage.pch 
